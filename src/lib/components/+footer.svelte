      ...
      >
        <nav aria-label="Footer Navigation - Support">
          <ul class="flex flex-wrap justify-center gap-4 text-xs lg:justify-end">
            <li>
              <a href="https://rugemporium.com.au/" class="text-neutral-500 transition hover:opacity-75">
                Rug Emporium
              </a>
            </li>
  
            <li>
              <a href="/documentation" class="text-neutral-500 transition hover:opacity-75">
                Documentation
              </a>
            </li>
        ...
        <ul class="flex justify-center gap-6 mt-8 sm:mt-0 lg:justify-end">
          <li>
            <a
              href="https://www.facebook.com/RugEmporiumAus"
              rel="noreferrer"
              target="_blank"
          ...
          <li>
            <a
              href="https://www.instagram.com/rugemporium"
              rel="noreferrer"
              target="_blank"
              class="text-neutral-700 transition hover:opacity-75"
            >
